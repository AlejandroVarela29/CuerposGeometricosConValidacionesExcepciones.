...
public class Main2{
    ...
    public static int pedirLados(int lados){
        ...
        int numero = 0;
            ...
            for (int i = 0; i < intentos; i++) {
                try {
                    System.out.print("Ingresa un numero positivo que este en el rango de 3 a 9 ");
                    numero = leer.nextInt();
    
                    if (numero <=3) {
                        System.out.println("Numero invalido ingresado. Intenta de nuevo.");
                    } else if(numero>=9){
                        System.out.println("Se ah execido del limite. Intente de nuevo");
                    }else{
                        return numero;
                    }
        ...
        public static int pediGrados(int grados){
     
        int numero = 0;
    
            for (int i = 0; i < intentos; i++) {
                try {
                    System.out.print("Ingresa un numero positivo que este en el rango de 1 a 360 ");
                    numero = leer.nextInt();
            ...
            for (int i = 0; i < intentos; i++) {
                try {
                   ...
                   if (numero <0) {
                        ...
                        System.out.println("Se ah excedido de la cantidad requerida");
                    }else{
                        return numero;
                    }
                } catch (java.util.InputMismatchException e) {
    ...
    public static void husoEsferico(){
        ...
        numeroDeGrados=pediGrados(numeroDeGrados);
    ...
    static double volumenCunaEsferica;
    static int  numeroDeGrados;
    //cuna esferica
